...
def scrapear_seccion(browser, categoria, url_base, max_paginas=None):
    ...
    print(f"\n{'='*60}")
    print(f"🛍️ Scrapeando sección: {categoria.upper()}")
    print(f"{'='*60}\n")
...
def elegir_secciones():
    ...
    alimentos = ['almacen', 'bebidas', 'lacteos', 'carnes', 'quesos', 'frutas', 'congelados', 'panaderia', 'pastas']
    no_alimentos = ['limpieza', 'perfumeria', 'bazar', 'mascotas', 'bebe', 'electronica', 'tiempo_libre']
